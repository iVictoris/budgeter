...
const Transaction = ({transactionID, description, debit, credit, category}) => {
  return (
    <section className="Transaction">
      ...
      <section className="Transaction-debit">{formatMoney(debit || "0")}</section>
      <section className="Transaction-credit">{formatMoney(credit || "0")}</section>
